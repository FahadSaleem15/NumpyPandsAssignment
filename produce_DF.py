...
produce.index = ['Rate','Quantity sold','Total Sale']

print(produce)
print("Question 1: Produce that had the highest and lowest sales in total sales (both name of produce and value)")
max_produce = produce.loc['Total Sale'].idxmax()
max_value = produce.loc['Total Sale'].max()
min_produce = produce.loc['Total Sale'].idxmin()
min_value = produce.loc['Total Sale'].min()
print(f"Produce: {max_produce}")
print(f"Max value: ${max_value}")
print(f"Produce: {min_produce}")
...
new_produce = produce.T[(produce.T['Quantity sold']>=11500) & (produce.T['Quantity sold']< 12000)]
print(new_produce)
...
print(new_produce['Total Sale'].sum())
